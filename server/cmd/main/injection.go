...
func inject(d *gorm.DB) (*gin.Engine, error) {
	...
	// service
	userService := service.NewUserService(userRepository, roleRepository, permissionRepository, menuRepository)
	...
	menuService := service.NewMenuService(menuRepository, roleRepository, permissionRepository)
